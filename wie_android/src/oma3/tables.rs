...
pub use crate::ma3::tables::{ATTACK_RATE_Q31, DECAY_RATE_Q30, KEYLEVEL_Q15, LEVEL_Q15, LFO_STEP_Q20, PHASE_DETUNE, SUSTAIN_Q31};
...
pub const DETUNE_CENTS: [f64; 16] = [
    -15.0, -11.0, -7.0, -3.0, 0.0, 3.0, 7.0, 11.0, 15.0, -24.0, -18.0, -12.0, 12.0, 18.0, 24.0, 0.0,
];
...
pub const MA3_FREQ_BASE: [f64; 128] = [
    ...
    130.8, 138.6, 146.9, 155.6, 164.8, 174.6, 185.0, 196.0, 207.7, 220.0, 233.1, 247.0, 261.6, 277.2, 293.7, 311.1, 329.6, 349.2, 370.0, 392.0,
    415.3, 440.0, 466.2, 493.9, 523.2, 554.4, 587.4, 622.2, 659.2, 698.4, 740.0, 784.0, 830.6, 880.0, 932.4, 987.8, 1046.4, 1108.8, 1174.8, 1244.4,
    1318.4, 1396.8, 1480.0, 1568.0, 1661.2, 1760.0, 1864.8, 1975.6, 2092.8, 2217.6, 2349.6, 2488.8, 2636.8, 2793.6, 2960.0, 3136.0, 3322.4, 3520.0,
    3729.6, 3951.2, 4185.6, 4435.2, 4699.2, 4977.6, 5273.6, 5587.2, 5920.0, 6272.0, 6644.8, 7040.0, 7459.2, 7902.4, 8371.2, 8870.4, 9398.4, 9955.2,
    10547.2, 11174.4, 11840.0, 12544.0,
];
