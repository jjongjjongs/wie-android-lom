...
impl ContainerComponent {
    pub fn as_proto() -> WieJavaClassProto {
        WieJavaClassProto {
            ...
            methods: vec![
                ...
                JavaMethodProto::new("getNumberOfComponent", "()I", Self::get_number_of_component, Default::default()),
                JavaMethodProto::new("controlInset", "(Z)V", Self::control_inset, Default::default()),
                JavaMethodProto::new("useFrame", "(Z)V", Self::use_frame, Default::default()),
                JavaMethodProto::new("paintFrame", "(Lorg/kwis/msp/lcdui/Graphics;)V", Self::paint_frame, Default::default()),
                ...
                JavaMethodProto::new("getIndexOf", "(Lorg/kwis/msp/lwc/Component;)I", Self::get_index_of, Default::default()),
                JavaMethodProto::new(
                ...
                JavaMethodProto::new("removeComponent", "(I)V", Self::remove_component_index, MethodAccessFlags::SYNCHRONIZED),
                JavaMethodProto::new(
                    "removeComponent",
                    "(Lorg/kwis/msp/lwc/Component;)V",
                ...
                JavaMethodProto::new("removeAllComponents", "()V", Self::remove_all_components, MethodAccessFlags::SYNCHRONIZED),
                JavaMethodProto::new(
                    "setComponent",
                    "(ILorg/kwis/msp/lwc/Component;)V",
                    Self::set_component,
            ...
            fields: vec![
                JavaFieldProto::new("children", "[Lorg/kwis/msp/lwc/Component;", Default::default()),
                JavaFieldProto::new("childCount", "I", Default::default()),
                JavaFieldProto::new("focusComponent", "Lorg/kwis/msp/lwc/Component;", Default::default()),
                ...
                JavaFieldProto::new("__wieContainerLayoutOverflow", "Z", Default::default()),
            ],
    ...
    async fn init(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<()> {
        ...
        let children = jvm.instantiate_array("Lorg/kwis/msp/lwc/Component;", 4).await?;

        let mut this = this;

        jvm.put_field(&mut this, "useFrame", "Z", false).await?;
        jvm.put_field(&mut this, "children", "[Lorg/kwis/msp/lwc/Component;", children).await?;
    ...
    async fn control_inset(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<Self>, enabled: bool) -> JvmResult<()> {
    ...
    async fn use_frame(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<Self>, enabled: bool) -> JvmResult<()> {
        ...
        let current: bool = jvm.get_field(&this, "useFrame", "Z").await?;

        if current == enabled {
            return Ok(());
        }

        jvm.put_field(&mut this, "useFrame", "Z", enabled).await?;

        let _: () = jvm.invoke_virtual(&this, "controlInset", "(Z)V", (enabled,)).await?;
    ...
    async fn paint_frame(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, graphics: ClassInstanceRef<()>) -> JvmResult<()> {
        ...
        if graphics.is_null() {
            let exception = jvm.instantiate_class("java/lang/NullPointerException").await?;
        ...
        let _: () = jvm
            .invoke_virtual(&graphics, "drawRoundRect", "(IIIIII)V", (0, 0, width - 1, height - 1, 3, 3))
            .await?;
    ...
    async fn paint(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, graphics: ClassInstanceRef<()>) -> JvmResult<()> {
        ...
        // this.paintContent(g)
        let _: () = jvm
            .invoke_virtual(&this, "paintContent", "(Lorg/kwis/msp/lcdui/Graphics;)V", (graphics.clone(),))
            .await?;
        ...
        if use_frame {
            let _: () = jvm
                .invoke_virtual(&this, "paintFrame", "(Lorg/kwis/msp/lcdui/Graphics;)V", (graphics.clone(),))
                .await?;
        }
        ...
        let _: () = jvm.invoke_virtual(&graphics, "translate", "(II)V", (offset_x, offset_y)).await?;
        ...
        let translated_x: i32 = jvm.invoke_virtual(&graphics, "getTranslateX", "()I", ()).await?;
        let translated_y: i32 = jvm.invoke_virtual(&graphics, "getTranslateY", "()I", ()).await?;

        // Native reset -> translate(saved translation) -> setClip.
        let _: () = jvm.invoke_virtual(&graphics, "reset", "()V", ()).await?;

        let _: () = jvm.invoke_virtual(&graphics, "translate", "(II)V", (translated_x, translated_y)).await?;

        let _: () = jvm
            .invoke_virtual(&graphics, "setClip", "(IIII)V", (local_clip_x, local_clip_y, clip_width, clip_height))
            .await?;
        ...
        let _: () = jvm
            .invoke_virtual(&graphics, "clipRect", "(IIII)V", (inner_x, inner_y, inner_width, inner_height))
            .await?;
        ...
        if child_count > 0 {
            ...
            loop {
                ...
                let values: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, index as usize, 1).await?;
                ...
                let child_x: i32 = jvm.get_field(&child, "x", "I").await?;
                let child_y: i32 = jvm.get_field(&child, "y", "I").await?;
                let child_width: i32 = jvm.get_field(&child, "w", "I").await?;
                let child_height: i32 = jvm.get_field(&child, "h", "I").await?;

                let intersects =
                    child_x < clip_right && local_clip_x < child_x + child_width && clip_bottom > child_y && local_clip_y < child_y + child_height;

                if intersects {
                    let _: () = jvm
                        .invoke_virtual(&graphics, "clipRect", "(IIII)V", (child_x, child_y, child_width, child_height))
                        .await?;

                    let _: () = jvm.invoke_virtual(&graphics, "translate", "(II)V", (child_x, child_y)).await?;

                    if jvm.is_instance(&**child, "org/kwis/msp/lwc/ContainerComponent") {
                        let _: () = jvm
                            .invoke_virtual(&child, "paint", "(Lorg/kwis/msp/lcdui/Graphics;)V", (graphics.clone(),))
                            .await?;
                    } else {
                        let _: () = jvm
                            .invoke_virtual(&child, "paintContent", "(Lorg/kwis/msp/lcdui/Graphics;)V", (graphics.clone(),))
                            .await?;
                    }
                    ...
                    let current_inset_top = jvm.get_field::<i16>(&this, "insetTop", "S").await? as i32;
                    let current_inset_bottom = jvm.get_field::<i16>(&this, "insetBottom", "S").await? as i32;
                    let current_inset_left = jvm.get_field::<i16>(&this, "insetLeft", "S").await? as i32;
                    let current_inset_right = jvm.get_field::<i16>(&this, "insetRight", "S").await? as i32;

                    let current_width: i32 = jvm.get_field(&this, "w", "I").await?;
                    let current_height: i32 = jvm.get_field(&this, "h", "I").await?;
                    let current_offset_x: i32 = jvm.get_field(&this, "offsetX", "I").await?;
                    let current_offset_y: i32 = jvm.get_field(&this, "offsetY", "I").await?;
                    ...
                    let _: () = jvm
                        .invoke_virtual(
                            ...
                            (
                                ...
                                current_width - current_inset_left - current_inset_right,
                                current_height - current_inset_top - current_inset_bottom,
                            ),
                        )
                        .await?;
                }
                ...
                let current_child_count: i32 = jvm.get_field(&this, "childCount", "I").await?;
        ...
        let final_offset_x: i32 = jvm.get_field(&this, "offsetX", "I").await?;
        let final_offset_y: i32 = jvm.get_field(&this, "offsetY", "I").await?;

        let _: () = jvm
            .invoke_virtual(&graphics, "translate", "(II)V", (-final_offset_x, -final_offset_y))
            .await?;
    ...
    async fn repaint(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<()> {
        ...
        let _: () = jvm
            .invoke_virtual(&this, "repaint", "(IIII)V", (-offset_x, -offset_y, width, height))
            .await?;
    ...
    async fn scroll_to(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, x: i32, y: i32) -> JvmResult<bool> {
        ...
        let parent: ClassInstanceRef<ContainerComponent> = jvm.get_field(&this, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;

        if parent.is_null() {
            return Ok(false);
        }

        jvm.invoke_virtual(&parent, "scrollTo", "(II)Z", (x, y)).await
    }
    ...
    async fn validate(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<()> {
        ...
        if mask & 0x1 == 0 {
            let _: () = jvm.invoke_special(&this, "org/kwis/msp/lwc/Component", "validate", "()V", ()).await?;
        }
        ...
        if child_count > 0 {
            ...
            loop {
                ...
                if child_mask & 0x1 == 0 {
                    let _: () = jvm.invoke_virtual(&child, "validate", "()V", ()).await?;
                }
        ...
        if mask & 0x4 != 0 {
            ...
            if target.is_null() {
                target = jvm
                    .invoke_virtual(&this, "getPrevTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                    .await?;
            }
        ...
        let _: bool = jvm.invoke_virtual(&this, "processEvent", "(IIII)Z", (1, 0, 0, 0)).await?;

        let mut current: ClassInstanceRef<ContainerComponent> = jvm.get_field(&this, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
        ...
        loop {
            let mut target: ClassInstanceRef<Component> = jvm
                .invoke_virtual(&current, "getNextTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                .await?;

            if target.is_null() {
                target = jvm
                    .invoke_virtual(&current, "getPrevTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                    .await?;
            }
    ...
    async fn get_index_of(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, component: ClassInstanceRef<Component>) -> JvmResult<i32> {
        let child_count: i32 = jvm.get_field(&this, "childCount", "I").await?;
        ...
        while index >= 0 {
            ...
            let same = if component.is_null() {
                ...
                !child.is_null() && child.identity() == component.identity()
            };
    ...
    async fn get_prev_traversal_component(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<ClassInstanceRef<Component>> {
        ...
        let focus_index: i32 = jvm
            .invoke_virtual(&this, "getIndexOf", "(Lorg/kwis/msp/lwc/Component;)I", (focus,))
            .await?;

        let child_count: i32 = jvm.get_field(&this, "childCount", "I").await?;

        let start = if focus_index >= 0 { focus_index } else { child_count };
            ...
            if mask & 0x4 != 0 {
                if jvm.is_instance(&**child, "org/kwis/msp/lwc/ContainerComponent") {
                    let nested: ClassInstanceRef<Component> = jvm
                        .invoke_virtual(&child, "getPrevTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                        .await?;
    ...
    async fn get_next_traversal_component(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<ClassInstanceRef<Component>> {
        ...
        loop {
            ...
            if mask & 0x4 != 0 {
                if jvm.is_instance(&**child, "org/kwis/msp/lwc/ContainerComponent") {
                    let nested: ClassInstanceRef<Component> = jvm
                        .invoke_virtual(&child, "getNextTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                        .await?;
    ...
    async fn get_focus_component(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<ClassInstanceRef<Component>> {
        ...
        loop {
            let parent: ClassInstanceRef<Component> = jvm.get_field(&current, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
        ...
        loop {
            let focus: ClassInstanceRef<Component> = jvm.get_field(&current, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;
            ...
            if !jvm.is_instance(&**focus, "org/kwis/msp/lwc/ContainerComponent") {
                let current_focus: ClassInstanceRef<Component> = jvm.get_field(&current, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;
            ...
            let next: ClassInstanceRef<Component> = jvm.get_field(&current, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;
            ...
            if !jvm.is_instance(&**next, "org/kwis/msp/lwc/ContainerComponent") {
    ...
    async fn find_branch(
        ...
        if !first.is_null() && !second.is_null() && first.identity() == second.identity() {
            let parent: ClassInstanceRef<Component> = jvm.get_field(&first, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
        ...
        while !outer.is_null() {
            ...
            while !inner.is_null() {
                ...
                inner = jvm.get_field(&inner, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
            }

            outer = jvm.get_field(&outer, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
        }
    ...
    async fn set_focus_component(
        ...
        let requested = if component.is_null() { this_component.clone() } else { component };

        // Native returns immediately when the requested component has no card.
        let card: ClassInstanceRef<()> = jvm.invoke_virtual(&requested, "getCard", "()Lorg/kwis/msp/lcdui/Card;", ()).await?;
        ...
        if shown {
            old_focus = jvm
                .invoke_virtual(&this, "getFocusComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                .await?;
            ...
            if old_focus.identity() != requested.identity() {
                ...
                if !found.is_null() {
                    ...
                    if !jvm.is_instance(&*found_raw, "org/kwis/msp/lwc/ContainerComponent") {
                        let exception = jvm.instantiate_class("java/lang/ClassCastException").await?;
                    ...
                    let old_branch_child: ClassInstanceRef<Component> =
                        jvm.get_field(&branch, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;

                    if !old_branch_child.is_null() && old_branch_child.identity() != requested.identity() {
                        let _: bool = jvm.invoke_virtual(&old_branch_child, "processEvent", "(IIII)Z", (1, 0, 0, 0)).await?;
                    }
                }
            }
        }
        ...
        jvm.put_field(&mut this, "focusComponent", "Lorg/kwis/msp/lwc/Component;", local_focus)
            .await?;
        ...
        loop {
            let parent: ClassInstanceRef<ContainerComponent> = jvm.get_field(&current, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;").await?;
            ...
            jvm.put_field(&mut parent_for_write, "focusComponent", "Lorg/kwis/msp/lwc/Component;", current.clone())
                .await?;
        ...
        if shown && old_focus.identity() != requested.identity() && !branch.is_null() {
            let new_branch_child: ClassInstanceRef<Component> = jvm.get_field(&branch, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;

            if !new_branch_child.is_null() {
                let _: bool = jvm.invoke_virtual(&new_branch_child, "processEvent", "(IIII)Z", (1, 0, 1, 0)).await?;
            }
        }
    ...
    async fn key_notify(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, event_type: i32, key: i32) -> JvmResult<bool> {
        ...
        let target: ClassInstanceRef<Component> = match game_action {
            // UP / LEFT
            1 | 2 => {
                jvm.invoke_virtual(&this, "getPrevTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                    .await?
            }

            // RIGHT / DOWN
            5 | 6 => {
                jvm.invoke_virtual(&this, "getNextTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                    .await?
            }
    ...
    async fn process_event(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, event: i32, p1: i32, p2: i32, p3: i32) -> JvmResult<bool> {
        match event {
            ...
            1 => {
                ...
                if !focus.is_null() {
                    let _: bool = jvm.invoke_virtual(&focus, "processEvent", "(IIII)Z", (1, p1, p2, p3)).await?;
                }

                let _: bool = jvm
                    .invoke_special(&this, "org/kwis/msp/lwc/Component", "processEvent", "(IIII)Z", (1, p1, p2, p3))
                    .await?;
            ...
            2 => {
                ...
                let initial_child_count: i32 = jvm.get_field(&this, "childCount", "I").await?;
                ...
                if initial_child_count > 0 {
                    loop {
                        ...
                        let _: bool = jvm.invoke_virtual(&child, "processEvent", "(IIII)Z", (2, p1, p2, p3)).await?;
                ...
                let _: bool = jvm
                    .invoke_special(&this, "org/kwis/msp/lwc/Component", "processEvent", "(IIII)Z", (2, p1, p2, p3))
                    .await?;
            ...
            3 => {
                ...
                if !focus.is_null() {
                    let handled: bool = jvm.invoke_virtual(&focus, "processEvent", "(IIII)Z", (3, p1, p2, p3)).await?;
                ...
                jvm.invoke_special(&this, "org/kwis/msp/lwc/Component", "processEvent", "(IIII)Z", (3, p1, p2, p3))
                    .await
            }
            ...
            4 => {
                ...
                if initial_child_count > 0 {
                    loop {
                        ...
                        let _: bool = jvm.invoke_virtual(&child, "processEvent", "(IIII)Z", (4, p1, p2, p3)).await?;
                ...
                let _: bool = jvm
                    .invoke_special(&this, "org/kwis/msp/lwc/Component", "processEvent", "(IIII)Z", (4, p1, p2, p3))
                    .await?;
    ...
    async fn add_component(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, component: ClassInstanceRef<Component>) -> JvmResult<i32> {
        ...
        let _: () = jvm
            .invoke_virtual(&this, "addComponent", "(ILorg/kwis/msp/lwc/Component;)V", (index, component))
            .await?;
    ...
    async fn add_component_index(
        ...
        if !parent.is_null() {
            let exception = jvm.new_class("java/lang/IllegalArgumentException", "()V", ()).await?;

            return Err(JavaError::JavaException(exception));
        }

        let children_before_inflate = jvm.get_field(&this, "children", "[Lorg/kwis/msp/lwc/Component;").await?;
        ...
        if requested >= capacity {
            let old_values: alloc::vec::Vec<ClassInstanceRef<Component>> = if capacity == 0 {
                alloc::vec::Vec::new()
            } else {
            ...
            let mut expanded = jvm.instantiate_array("Lorg/kwis/msp/lwc/Component;", new_capacity).await?;

            if !old_values.is_empty() {
                jvm.store_array(&mut expanded, 0, old_values).await?;
            }

            jvm.put_field(&mut this, "children", "[Lorg/kwis/msp/lwc/Component;", expanded).await?;
        }

        // Native re-reads childCount and children after checkAndInflateArray().
        let current_child_count: i32 = jvm.get_field(&this, "childCount", "I").await?;

        let mut children = jvm.get_field(&this, "children", "[Lorg/kwis/msp/lwc/Component;").await?;
        ...
        while pos > insertion_index {
            let value: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, pos - 1, 1).await?;

            jvm.store_array(&mut children, pos, [value[0].clone()]).await?;

            pos -= 1;
        }

        // Native implementation increments childCount before the aastore.
        jvm.put_field(&mut this, "childCount", "I", current_child_count + 1).await?;

        jvm.store_array(&mut children, insertion_index, [component.clone()]).await?;

        let mut component_for_parent = component.clone();
        jvm.put_field(&mut component_for_parent, "parent", "Lorg/kwis/msp/lwc/ContainerComponent;", this.clone())
            .await?;
        ...
        let values: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, 0, new_child_count as usize).await?;
        ...
        if shown {
            let _: bool = jvm.invoke_virtual(&component, "processEvent", "(IIII)Z", (2, 0, 1, 0)).await?;
        }

        // WipiPlayer Plus checks isShown() again before automatic focus.
        let shown_for_focus: bool = jvm.invoke_virtual(&this, "isShown", "()Z", ()).await?;
        ...
        if shown_for_focus {
            if old_focus.is_null() {
                ...
                let local_focus: ClassInstanceRef<Component> = jvm.get_field(&this, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;
        ...
        let component_mask: i32 = jvm.get_field(&component, "mask", "I").await?;

        if can_assign_initial_focus && component_mask & 0x4 != 0 {
            let mut focus_target = component.clone();

            if jvm.is_instance(&**component, "org/kwis/msp/lwc/ContainerComponent") {
                let nested: ClassInstanceRef<Component> = jvm
                    .invoke_virtual(&component, "getNextTraversalComponent", "()Lorg/kwis/msp/lwc/Component;", ())
                    .await?;
            ...
            let _: () = jvm.invoke_virtual(&focus_target, "setFocus", "()V", ()).await?;
        }
    ...
    async fn set_component(
        ...
        let old_values: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, index as usize, 1).await?;

        let old = old_values[0].clone();

        let focus: ClassInstanceRef<Component> = jvm.get_field(&this, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;

        let transfer_focus = if focus.is_null() && old.is_null() {
            let exception = jvm.instantiate_class("java/lang/NullPointerException").await?;

            return Err(JavaError::JavaException(exception));
        } else if !focus.is_null() && !old.is_null() && focus.identity() == old.identity() {
            let _: bool = jvm.invoke_virtual(&old, "processEvent", "(IIII)Z", (1, 0, 0, 0)).await?;
        ...
        if shown {
            let shown_children = jvm.get_field(&this, "children", "[Lorg/kwis/msp/lwc/Component;").await?;

            let shown_old_values: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&shown_children, index as usize, 1).await?;
            ...
            let _: bool = jvm.invoke_virtual(&shown_old, "processEvent", "(IIII)Z", (2, 0, 0, 0)).await?;

            let _: bool = jvm.invoke_virtual(&component, "processEvent", "(IIII)Z", (2, 0, 1, 0)).await?;
        }

        let mut current_children = jvm.get_field(&this, "children", "[Lorg/kwis/msp/lwc/Component;").await?;

        jvm.store_array(&mut current_children, index as usize, [component.clone()]).await?;
        ...
        if transfer_focus {
            let _: () = jvm.invoke_virtual(&component, "setFocus", "()V", ()).await?;
        }
    ...
    async fn remove_all_components(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<()> {
        ...
        if !focus.is_null() {
            let _: bool = jvm.invoke_virtual(&focus, "processEvent", "(IIII)Z", (1, 0, 0, 0)).await?;
        }
        ...
        let values: alloc::vec::Vec<ClassInstanceRef<Component>> = if child_count > 0 {
        ...
        for child in values {
            ...
            if shown {
                let _: bool = jvm.invoke_virtual(&child, "processEvent", "(IIII)Z", (2, 0, 0, 0)).await?;
            }
        }

        jvm.put_field(&mut this, "childCount", "I", 0).await?;

        let new_children = jvm.instantiate_array("Lorg/kwis/msp/lwc/Component;", 4).await?;

        jvm.put_field(&mut this, "children", "[Lorg/kwis/msp/lwc/Component;", new_children)
            .await?;
    ...
    async fn remove_component_index(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>, index: i32) -> JvmResult<()> {
        ...
        let removed_values: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, index as usize, 1).await?;
        let removed = removed_values[0].clone();

        // WipiPlayer Plus sends FOCUS(false) before detaching the child.
        let focus: ClassInstanceRef<Component> = jvm.get_field(&this, "focusComponent", "Lorg/kwis/msp/lwc/Component;").await?;

        if !focus.is_null() && !removed.is_null() && focus.identity() == removed.identity() {
            let _: bool = jvm.invoke_virtual(&removed, "processEvent", "(IIII)Z", (1, 0, 0, 0)).await?;
        }
        ...
        while pos + 1 < old_count {
            let next: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, pos + 1, 1).await?;

            jvm.store_array(&mut children, pos, [next[0].clone()]).await?;

            pos += 1;
        }

        let new_count = child_count - 1;
        jvm.put_field(&mut this, "childCount", "I", new_count).await?;

        // Native code clears the stale tail only when children remain.
        // If count becomes zero, children[0] is left stale but ignored.
        if new_count > 0 {
            jvm.store_array(&mut children, new_count as usize, [ClassInstanceRef::<Component>::new(None)])
                .await?;
        }
        ...
        while scan_index > 0 {
            let child: alloc::vec::Vec<ClassInstanceRef<Component>> = jvm.load_array(&children, scan_index as usize, 1).await?;

            if !child[0].is_null() {
                let child_mask: i32 = jvm.get_field(&child[0], "mask", "I").await?;
        ...
        if shown {
            let _: bool = jvm.invoke_virtual(&removed, "processEvent", "(IIII)Z", (2, 0, 0, 0)).await?;
        }
    ...
    async fn remove_component(
        ...
        let index: i32 = jvm
            .invoke_virtual(&this, "getIndexOf", "(Lorg/kwis/msp/lwc/Component;)I", (component,))
            .await?;
        ...
        let _: () = jvm.invoke_virtual(&this, "removeComponent", "(I)V", (index,)).await?;
