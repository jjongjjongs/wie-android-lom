...
impl ProxyCard {
    ...
    async fn init(
        ...
        tracing::debug!(
            "org.kwis.msp.lwc.ProxyCard::<init>({this:?}, {display_ref:?}, {component:?}, {transparent})"
        );
    ...
    async fn get_component(
        ...
        _: &mut WieJvmContext,
        this: ClassInstanceRef<Self>,
    ) -> JvmResult<ClassInstanceRef<ContainerComponent>> {
        jvm.get_field(
            &this,
            "component",
            "Lorg/kwis/msp/lwc/ContainerComponent;",
    ...
    async fn show_notify(
        ...
        let component: ClassInstanceRef<ContainerComponent> = jvm
            .get_field(
                &this,
                "component",
                "Lorg/kwis/msp/lwc/ContainerComponent;",
        ...
        if component.is_null() {
            return Err(
                jvm.exception("java/lang/NullPointerException", "component is null")
                    .await,
            );
        }
