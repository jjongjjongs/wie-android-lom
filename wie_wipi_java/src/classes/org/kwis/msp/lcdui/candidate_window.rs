...
impl CandidateWindow {
    pub fn as_proto() -> WieJavaClassProto {
        WieJavaClassProto {
            ...
            interfaces: vec![],
            methods: vec![
                JavaMethodProto::new("<init>", "(Lorg/kwis/msp/lcdui/InputMethodHandler;)V", Self::init, Default::default()),
                JavaMethodProto::new("setDiableChars", "([C)V", Self::set_diable_chars, Default::default()),
                JavaMethodProto::new("setPosition", "(IIII)V", Self::set_position, Default::default()),
                JavaMethodProto::new("showNotify", "()V", Self::show_notify, Default::default()),
                JavaMethodProto::new("setCandidateList", "(I)V", Self::set_candidate_list, Default::default()),
                JavaMethodProto::new("notifyData", "()V", Self::notify_data, Default::default()),
            ],
            fields: vec![
                JavaFieldProto::new("__wieInputMethodHandler", "Lorg/kwis/msp/lcdui/InputMethodHandler;", Default::default()),
    ...
    async fn init(
        ...
        jvm.put_field(&mut this, "__wieInputMethodHandler", "Lorg/kwis/msp/lcdui/InputMethodHandler;", handler)
            .await?;

        jvm.put_field(&mut this, "__wieCandidateIndex", "I", 0).await?;
        ...
        let (left_x, right_x) = match width {
            ...
            320 => (69, 246),
            _ => {
                return Err(jvm.exception("java/lang/IllegalArgumentException", "Unknown ").await);
            }
        };
        ...
        let font_width: i32 = jvm.invoke_virtual(&font, "stringWidth", "(Ljava/lang/String;)I", (measure,)).await?;
        ...
        jvm.put_field(&mut this, "__wieMaxLength", "I", max_length).await?;
        jvm.put_field(&mut this, "__wieInputX", "I", left_x).await?;
    ...
    async fn set_diable_chars(
        ...
        jvm.put_field(&mut this, "__wieDisableChars", "[C", chars).await
    }

    async fn set_position(_: &Jvm, _: &mut WieJvmContext, _: ClassInstanceRef<Self>, _: i32, _: i32, _: i32, _: i32) -> JvmResult<()> {
        // Native CandidateWindow.setPosition only emits platform logging.
        Ok(())
    }

    async fn show_notify(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<()> {
        jvm.invoke_virtual(&this, "setCandidateList", "(I)V", (0,)).await
    }

    async fn set_candidate_list(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<Self>, index: i32) -> JvmResult<()> {
        ...
        jvm.put_field(&mut this, "__wieCandidateIndex", "I", index).await
    }

    async fn notify_data(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<Self>) -> JvmResult<()> {
        ...
        let mut data: ClassInstanceRef<Array<JavaChar>> = jvm.get_field(&this, "__wieData", "[C").await?;

        if count > 0 {
            let mut chars: Vec<JavaChar> = jvm.load_array(&data, 0, count as usize).await?;
            ...
            jvm.put_field(&mut this, "__wieData", "[C", data.clone()).await?;
        }

        let handler: ClassInstanceRef<InputMethodHandler> = jvm
            .get_field(&this, "__wieInputMethodHandler", "Lorg/kwis/msp/lcdui/InputMethodHandler;")
            .await?;

        jvm.invoke_virtual(&handler, "notifyDataSelected", "([CII)V", (data, count, -1)).await
    }
}
