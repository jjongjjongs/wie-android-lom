...
// class org.kwis.msp.media.MediaUnavailableException
pub struct MediaUnavailableException;

impl MediaUnavailableException {
    ...
    async fn init(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> Result<()> {
        tracing::debug!("org.kwis.msp.media.MediaUnavailableException::<init>({this:?})");
