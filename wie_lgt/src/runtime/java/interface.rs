...
pub fn get_java_interface_method(core: &mut ArmCore, function_index: u32) -> Result<u32> {
    let method = match function_index {
        ...
        0x0d => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmInitializeClass)?,
        0x0f => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmInstantiate)?,
        0x12 => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmClassIsAssignableTo)?,
        ...
        0x0e => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmGetArrayClass)?,
        0x10 => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmInstantiateArray)?,
        0x11 => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmInstantiateMultiArray)?,
        0x21 => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmThrowException)?,
        0x22 => core.make_svc_stub(SVC_CATEGORY_INIT, InitSvcId::VmThrowNullPointerException)?,
